...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Libro', 'url' => ['/asistencia/libro'],'visible' => !Yii::$app->user->isGuest],
            ...
            ['label' => 'Guardavidas Puesto', 'url' => ['/guardavidas-puesto'],'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->idRol== \app\models\Asistencia::ROL_ADMIN],
