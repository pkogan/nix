...
<div class="asistencia-search">
    ...
    <?php echo $form->field($model,'idGuardavidas')->dropDownList(yii\helpers\ArrayHelper::map(\app\models\Guardavidas::find()->where('idRol='.\app\models\Asistencia::ROL_GUARDAVIDAS)->all(),'idGuardavidas','Nombre'),['prompt' => 'Todos']) ?>
